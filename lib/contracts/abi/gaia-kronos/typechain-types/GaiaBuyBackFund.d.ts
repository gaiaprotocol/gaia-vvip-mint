...
export interface GaiaBuyBackFundInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "buyBackInitialized", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "buyBackInitialized", data: BytesLike): Result;
...
export interface GaiaBuyBackFund extends BaseContract {
    ...
    populateTransaction: {
        ...
        buyBackInitialized(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        closeBuyBack(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<PopulatedTransaction>;
        renounceOwnership(overrides?: Overrides & {
