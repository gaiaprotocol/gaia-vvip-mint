...
class Home {
    constructor() {
        ...
        Layout_1.default.current.content.append(this.container = (0, skydapp_browser_1.el)(".home-view", (0, skydapp_browser_1.el)("h1", "Gaia Kronos Sale"), (0, skydapp_browser_1.el)("h2", "for VVIP"), (0, skydapp_browser_1.el)(".sale-container", (0, skydapp_browser_1.el)("h3", "sale NFT"), this.status = (0, skydapp_browser_1.el)("p", "...")), (0, skydapp_browser_1.el)("h4", "price: 1,000 KLAY"), this.nftList = (0, skydapp_browser_1.el)(".nft-container")));
